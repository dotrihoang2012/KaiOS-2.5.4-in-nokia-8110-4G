...
help:
	...
	@echo "    makefilesideload INPUT=f.zip Sideload a signed ZIP via ADB"
	@echo "    makefilewipe                 Wipe data partition"
	@echo ""
	@echo "  PACKAGE"
	@echo "    makefilesign INPUT=f.zip     Sign a ZIP with test-keys"
	@echo "    makefilebuild-installer      Build OTA installer package"
	@echo "    makefilebuild-installer VERSION=1.0.0"
	@echo ""
	@echo "  CLEAN"
